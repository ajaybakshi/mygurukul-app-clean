#!/usr/bin/env python3
"""
Bhagavad Gita Chapter Manifest Generator

Generates a chapter manifest JSON file for Bhagavad Gita based on the folder structure.
"""
...
SCRIPTURE_ID = "bhagvad_gita"
SCRIPTURE_NAME = "Bhagavad Gita"
SECTION_ID = "1"
SECTION_NAME = "Bhagavad Gita Chapters"
GCS_BUCKET = "gs://mygurukul-sacred-texts-corpus"
GCS_BASE_PATH = "Gurukul_Library/Primary_Texts/Epics/Bhagvad_Gita"
...
def get_chapter_number(folder_name: str) -> int:
    """Extract chapter number from folder name like 'Bhagavad_Gita_Chapter 1 Yoga of...'"""
...
def derive_fallback_title(folder_name: str) -> str:
    ...
    # Remove "Bhagavad_Gita_Chapter X" prefix
    cleaned = re.sub(r"^Bhagavad_Gita_Chapter\s+\d+\s+", "", folder_name, flags=re.IGNORECASE)
...
def generate_chapter_manifest(root_directory: str):
    print("=" * 80)
    print("CHAPTER MANIFEST GENERATOR - BHAGAVAD GITA")
    print("=" * 80)
    ...
    for directory in directories:
        ...
        # Construct GCS URLs
        # Pattern: gs://mygurukul-sacred-texts-corpus/Gurukul_Library/Primary_Texts/Epics/Bhagvad_Gita/Bhagavad_Gita_Chapter 1 Yoga of the Dejection of Arjuna/...
...
def main():
    ...
    print("╔══════════════════════════════════════════════════════════╗")
    print("║                                                          ║")
    print("║  MYGURUKUL CHAPTER MANIFEST GENERATOR - BHAGAVAD GITA     ║")
    print("║                                                          ║")
    print("╚══════════════════════════════════════════════════════════╝")
    print("\n")

...
SCRIPTURE_ID = "aryabhatia"
SCRIPTURE_NAME = "Āryabhaṭīya"
SECTION_ID = "1"
SECTION_NAME = "Āryabhaṭīya Chapters"
GCS_BUCKET = "gs://mygurukul-sacred-texts-corpus"
GCS_BASE_PATH = "Gurukul_Library/Primary_Texts/Vigyan/Aryabhatia"
...
def get_chapter_number(path_name: str) -> int:
    """Extract chapter number from folder or filename."""
...
def derive_fallback_title(folder_name: str) -> str:
    """Return a human-readable title derived from folder name."""
...
def iter_chapter_dirs(root_path: Path):
    """Yield chapter directories that contain at least one PDF."""
...
def generate_chapter_manifest(root_directory: str):
    print("=" * 80)
    print("CHAPTER MANIFEST GENERATOR - ĀRYABHAṬĪYA")
    print("=" * 80)
...
def main():
    ...
    print("╔══════════════════════════════════════════════════════════╗")
    print("║                                                          ║")
    print("║    MYGURUKUL CHAPTER MANIFEST GENERATOR - ĀRYABHAṬĪYA    ║")
    print("║                                                          ║")
    print("╚══════════════════════════════════════════════════════════╝")
    print("\n")

...
# Create the chapter manifest generation script
...
# Save the script
with open('generate_chapter_manifest.py', 'w', encoding='utf-8') as f:
    f.write(script_content)

print("✅ Created: generate_chapter_manifest.py")
print("\n📋 Script Features:")
print("  • Scans local Caraka Samhita folder structure")
print("  • Extracts section and chapter information")
print("  • Validates PDF + JSON file pairs")
print("  • Generates GCS URLs for all files")
print("  • Validates manifest completeness")
print("  • Saves as caraka_samhita_chapter_manifest.json")
print("\n🎯 Next Steps:")
print("  1. Update SCRIPTURE_ROOT path in the script (line 9)")
print("  2. Run: python generate_chapter_manifest.py")
print("  3. Review generated JSON")
print("  4. Upload files to GCS as instructed")
